...
# ╔═╡ dab2dc40-edd3-11ec-2f70-25cc934a3be3
begin
	using DataFrames, Plots, StatsBase, Distributions, Statistics, LsqFit, Distributed, NaNStatistics, Base.Threads, Revise, PlutoUI
...
# ╔═╡ a0c89feb-e39e-4596-95e0-1a7539c643bd
md"""
##### Initalization"""

# ╔═╡ 613f3120-774c-4db0-a061-db7d6b0ca8ef
md"""
...
# ╔═╡ dd7c57bc-2b3e-4e3a-8c7a-584f9b3f82ee
begin
	function GroundTruthPlot(valid_stims, pDetected, detection_threshold, jnd)
		GroundTruthPlot = plot(background_color = "rgb(30,30,30)", legend=false, xlabel = "Stimulus Intensity (μA)",
		    ylabel = "p(Detected)", xlim=(0, 102))
		...
		for (l,c) in zip(labels, label_colors)
		    annotate!(GroundTruthPlot, 5, yl, l, annotationfontsize = 9, annotationhalign=:left,
		        annotationvalign=:top, annotationcolor=c)
		    yl = yl - y_dec
		end
...
# ╔═╡ 17aa563f-84eb-46b1-94b9-09e51b383bcc
gtr = GroundTruthPlot(valid_stims, pDetected, detection_threshold, jnd)

# ╔═╡ a0448103-9bb5-43a3-bd32-78420765175a
...
git-tree-sha1 = "3be924b25d056b3ab717f1ff4b302e1a2b3c20ab"
